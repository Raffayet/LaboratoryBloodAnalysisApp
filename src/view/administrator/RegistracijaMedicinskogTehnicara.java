...
public class RegistracijaMedicinskogTehnicara extends JFrame {
...
//	}
	 ...
	 * Create the frame.
	 */
	public RegistracijaMedicinskogTehnicara(String korisnickoImeUlogovanogKorisnika) {
		
		setTitle("Registracija medicinskih tehnicara");
		...
		muski.setBounds(602, 600, 81, 24);
		contentPane.add(muski);
		
		zenski.setBounds(728, 600, 81, 24);
		...
		lblNewLabel_5.setIcon(new ImageIcon(RegistracijaMedicinskogTehnicara.class.getResource("/slike/registracijaMedicinskihTehnicara.png")));
		lblNewLabel_5.setBounds(0, 0, 501, 654);
		...
		lblNewLabel_3_1_1.setBounds(602, 569, 234, 24);
		...
		dugmeZaRegistraciju.setBounds(882, 600, 115, 43);
		...
		lblNewLabel_6.setBounds(689, 596, 25, 34);
		...
		lblNewLabel_7.setBounds(815, 596, 25, 34);
		...
		dugmeZaRegistraciju.addActionListener(new ActionListener() {
			...
			private void proveraOdabiraPola(String korisnickoIme, String lozinka, String ime, String prezime, String adresa, String telefon, String datumRodjenja, String osnova,
				...
				if (!muski.isSelected() && !zenski.isSelected()) {
					...
					setVisible(false);
					KorisniciController.registracijaMedicinskogTehnicara(korisnickoIme, lozinka, ime, prezime, adresa, telefon, pol, datumRodjenja, osnova, koeficijent,
